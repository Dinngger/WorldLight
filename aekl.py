...
class MNISTDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.mnist_val = torchvision.datasets.MNIST(self.dataset_dir,
            train=False, download=False, transform=self.transform)
...
batch_size = 128
dm = MNISTDataModule('/media/dinger/inner/Dataset/pytorch_data', batch_size=batch_size)
model = AutoencoderKL()
model.learning_rate = batch_size * 8e-6
trainer = pl.Trainer(
    accelerator="auto",
    max_epochs=30,
